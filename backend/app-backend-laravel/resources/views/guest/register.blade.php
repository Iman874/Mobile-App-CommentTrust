...
@section('title', 'Register - CommentTrust')
...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
    <div class="w-full max-w-md bg-white rounded-lg shadow-xl p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Join CommentTrust today</p>
        </div>

        @if ($errors->any())
            <div class="mb-6 p-4 bg-red-100 border border-red-400 text-red-700 rounded">
                <p class="font-medium mb-2">Registration failed:</p>
        ...
        <form method="POST" action="{{ route('guest.login') }}" class="mb-4">
            ...
            <p class="text-xs text-gray-500 text-center mt-2">
                Skip registration. Valid for 24 hours.
            </p>
        </form>
